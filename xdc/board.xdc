...
set_property  -dict {PACKAGE_PIN B5  IOSTANDARD LVCMOS33} [get_ports { GPIO_LED[0]     }] ;# USER_LED0
set_property  -dict {PACKAGE_PIN A5  IOSTANDARD LVCMOS33} [get_ports { GPIO_LED[1]     }] ;# USER_LED1
set_property  -dict {PACKAGE_PIN A4  IOSTANDARD LVCMOS33} [get_ports { GPIO_LED[2]     }] ;# USER_LED2
set_property  -dict {PACKAGE_PIN C5  IOSTANDARD LVCMOS33} [get_ports { GPIO_LED[3]     }] ;# USER_LED3
set_property  -dict {PACKAGE_PIN C6  IOSTANDARD LVCMOS33} [get_ports { GPIO_LED[4]     }] ;# USER_LED4
